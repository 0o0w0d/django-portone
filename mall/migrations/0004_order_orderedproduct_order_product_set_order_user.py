# Generated by Django 4.2.17 on 2025-01-01 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('requested', '주문 요청'), ('failed_payment', '결제 실패'), ('paid', '결제 완료'), ('prepared_product', '상품 준비중'), ('shipped', '배송중'), ('delivered', '배송완료'), ('canceled', '주문 취소')], db_index=True, default='requested', max_length=20, verbose_name='진행 상황')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='주문 시점의 상품명을 저장합니다.', max_length=255, verbose_name='상품명')),
                ('price', models.PositiveIntegerField(help_text='주문 시점의 가격을 저장합니다.', verbose_name='상품가격')),
