# Generated by Django 4.2.17 on 2025-01-04 10:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.CharField(choices=[('card', '카드')], default='card', max_length=20, verbose_name='결제 수단')),
                ('pay_status', models.CharField(choices=[('ready', '결제 준비'), ('paid', '결제 완료'), ('canceled', '결제 취소'), ('failed', '결제 실패')], default='ready', max_length=20, verbose_name='결제 상태')),
                ('is_paid_ok', models.BooleanField(db_index=True, default=False, editable=False, verbose_name='결제 성공 여부')),
